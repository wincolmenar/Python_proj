...
GJ_input_folder_path = os.path.join(os.path.expanduser("~"), "OneDrive - Bayer", "Desktop", "BCS File Converter", "GJ Input Folder")
GJ_output_folder_path = os.path.join(os.path.expanduser("~"), "OneDrive - Bayer", "Desktop", "BCS File Converter", "GJ Output Folder")


## GUI script
# Create the window
root = Tk()
root.title("BCS GL GJ Converter")
