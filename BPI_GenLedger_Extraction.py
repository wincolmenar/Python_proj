...
input_folder_path = os.path.join(os.path.expanduser("~"), "OneDrive - Bayer", "Desktop", "File Converter", "GJ Input Folder")
output_folder_path = os.path.join(os.path.expanduser("~"), "OneDrive - Bayer", "Desktop", "File Converter", "GJ Output Folder")

## GUI script
# Create the window
root = Tk()
root.title("GJ Converter")
...
# function for the window messages
...
execute_button = Button(root, text = "Convert", command = run_trim_function, padx = 30)
# shoving into the window
